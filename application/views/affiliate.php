    ...
    <div class="container position-relative text-center text-lg-start" data-aos="zoom-in" data-aos-delay="100">
        <div class="row">
            <div class="col-lg-6 m-funding align-items-center d-flex align-items-center justify-content-center flex-column">
                ...
                <p style="margin: 1rem 0 0 24px; font-size:16px; color:#000000; width:90%">Start earning upto <strong style= "color:#0d6efd">15%</strong> commission on every referral.</p>
                    ...
                    <a href="client-login">
                        <div class="card text-dark" data-aos="fade-up" data-aos-delay='100'>
                            <div class="card-body">
                                ...
                                <p class="mt-3" style="font-size:14px">Equinox Trading Capital is offering upto <strong style= "color:#0d6efd">15%</strong> commission for our affiliates which is the industry-highest. Simply register with us in a few minutes and start sharing your affiliate link to earn generously.</p>
                            </div>
                        </div>
                    </a>
                </div>
...
<li class="text-dark list-disc pt-8"><p>The Available Payout Methods for Equinox Trading Capital Affiliates are: <strong style= "color:#0d6efd">Bank Transfer, Crypto & Paypal</strong>.</p></li>
