...
<div class="content-wrapper">
  ...
  <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">User /</span> Faq or Help</h4>
                ...
                <div class="tab-pane fade active show" id="navs-top-home" role="tabpanel"> 
                    <div class="container" data-aos="fade-up">
                        <div class="d-flex m-5" id="myFilter">
                            <input type="text" style="width:100%"  class="col-lg-3 form-control" onkeyup="myFunction()" placeholder="Search for Faq">
