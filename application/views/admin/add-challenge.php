              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  <div class="mb-3">
                    ...
                    <input required type="text" id="product-description" class="form-control phone-mask" name="description" placeholder="Enter prodcut description">
                  </div>
                </div>
                <div class="col-lg-4">
                  <div class="mb-3">
                ...
                <div class="col-lg-4">
                  <div class="mb-3">
                      ...
                      <input required type="number" id="profit-target" name="profit-target" class="form-control phone-mask" placeholder="Enter Profit Target">
                    </div>
                </div>
                <div class="col-lg-4">
                  <div class="mb-3">
