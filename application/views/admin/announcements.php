    ...
    <div class="row">
              ...
              <div class="card-body">
                <form id="formAccountSettings" method="POST" onsubmit="return false">
                  <div class="row">
                    ...
                    <div class="mb-3 col-md-12">
                      <label for="content" class="form-label">4 June 2030</label>
        ...
        <div class="card">
          ...
          <div class="card-body row align-items-center">
            <div class="mb-3 col-lg-12 mb-0">
                <h6 class="alert-heading fw-bold mb-3">4 June 2030</h6>
                <p class="mb-0">
      ...
      <div class="col-md-4 my-5 mx-auto">
        <div class="card">
          ...
          <div class="card-body row align-items-center">
            <div class="mb-3 col-lg-12 mb-0">
                <h6 class="alert-heading fw-bold mb-3 text-center">4 June 2030</h6>
                <p class="mb-0">
                  your content hereyour content here your content here your content here your content here your content here <br>
                  your content hereyour content hereyour content here
                </p>
