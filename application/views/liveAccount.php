    ...
    <section style="margin: 6rem auto 0 auto;padding-bottom: 0;">
        <div class="container" data-aos="fade-up">
            <div class="section-title text-center">
                <h2>Live Account Disclaimer</h2>
                <p class="d-block pt-3 fw-bold">Funded Account Disclaimer-</p>
                <p class="d-block py-0">Hypothetical or simulated performance results have certain limitations. Unlike an actual performance record, simulated results do not represent actual trading. 
