...
$qrCodeUrl = $Authenticator->getQR('Demo', $_SESSION['auth_secret']);
...
<head>
    <meta charset="UTF-8">
    <title>Addressme || Two factor Authentication</title>
    <link rel="icon" href="favicon.ico" type="<?= base_url?>images/favicon.io" />
    ...
    <style>
        ...
        .bg { 
           ...
           background:linear-gradient(5deg, #ababab, #cacaca2b);
...
<body  class="bg">
    <div class="container">
        <div class="row">
            <div class="col-md-6 offset-md-3"  style="background: white; padding: 20px; box-shadow: 0 0 8px #bebebe; margin-top: 100px;">
                <h1 style="text-align:center;font-size: 1.5rem;"><span style="font-family: 'Caveat', cursive;">Addressme</span> keeps your profile safe</h1>
                <p style="font-style: italic;">Two Factor Authentication</p>
                <hr>
