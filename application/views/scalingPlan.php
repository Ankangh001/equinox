                ...
                <table class="account-config">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td x-text="currentConfig[1][0]">50,000 (10%)</td>
                            <td x-text="currentConfig[2][0]">80%</td>
                        </tr>
                        <tr>
                            <td>2</td>
                            ...
                            <td x-text="currentConfig[1][0]">75,000 (10%)</td>
                            <td x-text="currentConfig[2][0]">90%</td>
                        </tr>
                        <tr>
                            <td>3</td>
                        ...
                        <tr>
                            <td>7</td>
                            <td x-text="currentConfig[0][0]">2,000,000</td>
                            <td x-text="currentConfig[0][0]"></td>
                            <td x-text="currentConfig[1][0]">200,000 (10%)</td>
                            <td x-text="currentConfig[2][0]">90%</td>
                        </tr>
                    </tbody>
                </table>
