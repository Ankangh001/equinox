...
<head>
  ...
  <!-- Vendor CSS Files -->
  <link href="<?= base_url('assets/') ?>vendor/animate.css/animate.min.css?v3=1" rel="stylesheet">
  <link href="<?= base_url('assets/') ?>vendor/aos/aos.css?v3=1" rel="stylesheet">
  <link href="<?= base_url('assets/') ?>vendor/bootstrap/css/bootstrap.min.css?v3=1" rel="stylesheet">
  <link href="<?= base_url('assets/') ?>vendor/bootstrap-icons/bootstrap-icons.css?v3=1" rel="stylesheet">
  <link href="<?= base_url('assets/') ?>vendor/boxicons/css/boxicons.min.css?v3=1" rel="stylesheet">
  <link href="<?= base_url('assets/') ?>vendor/glightbox/css/glightbox.min.css?v3=1" rel="stylesheet">
...
.game-btn{
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css?v3=1" integrity="sha512-iecdLmaskl7CVkqkXNQ/ZH/XLlvWZOJyj7Yy7tcenmpD1ypASozpmT/E0iPtmFIB46ZmdtAc9eNBvH0H/ZpiBw==" crossorigin="anonymous" referrerpolicy="no-referrer" />
</head>
...
<body>
    ...
    <div style="max-width: 96% !important;" class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="ml-auto navbar order-last d-none order-lg-0">
        <ul>
