    ...
    <section style="margin: 6rem auto 0 auto;padding-bottom: 0;">
        <div class="container" data-aos="fade-up">
            <div class="section-title text-center">
                ...
                <p class="d-block py-3">
                Overview
<br/><br/>
By using our site and/or purchasing something from us, you participate in our 'Service' and agree to be bound by the following terms and conditions ('Terms of Service', 'Terms'), as well as any other terms and conditions and policies linked herein and/or accessible through a hyperlink. These Terms of Service apply to all users of the site, including but not limited to browsers, vendors, consumers, merchants, and/or content creators.
<br/><br/>
...
<br/><br/>
You must pay registration fees in order to have access to the Equinox Trading Capital  (a concern of Equinox Trading Capital Ltd) platform, models, and services. If the service has begun (i.e the client has started trading and/or the client has not successfully completed the Evaluation, the customer is not entitled to a refund of the registration fee, Model, Normal, and Aggressive that are part of the Equinox Trading Capital offer are not due a refund.
<br/><br/><br/>
Section 1 - Terms of Online Registration
<br/><br/>
In signing these Terms of Service, you officially confirm that you are of legal age in your state or province of residence, or that you are of legal age and have given us your permission to allow any of your minor children to use this site. As a condition of using the Service, you agree that you will not engage in any illegal or unauthorised activity (including but not limited to copyright laws). Your Services will be terminated immediately if you violate any of the Terms.
<br/><br/><br/>
...
<br/><br/>
We may, but are under no obligation to, monitor, edit, or delete material that we consider to be illegal, offensive, threatening, libelous, defamatory, pornographic, obscene, or otherwise objectionable, or that infringes any party's intellectual property or these Terms of Service.
<br/><br/>
...
<br/><br/>
Our Privacy Policy governs the submission of personal data through the website.
<br/><br/><br/>
...
<br/><br/>The Customer is prohibited from engaging, either alone or in cooperation with others, in any trades or combination of trades across connected accounts or accounts held with different Equinox Trading Capital entities, if the purpose of such trades is to manipulate trading. Examples of such manipulation include entering into opposite positions simultaneous
<br/><br/>The Customer is prohibited from conducting trades that violate the terms and conditions of Equinox Trading Capital. Any trades that go against these terms and conditions are not allowed. The Customer must comply with the rules set by Equinox Trading Capital and the Trading Platform when using the Services
<br/><br/>Do not use any software, artificial intelligence, ultra-high speed, or mass data entry that could manipulate or abuse our systems or services, or give you an unfair advantage.
<br/><br/>The Customer is prohibited from performing gap trading by opening trades during scheduled major global news, macroeconomic events, or corporate reports or earnings that may affect the relevant financial market for trading financial instruments.
<br/><br/>The customer is not allowed to perform trades that are inconsistent with the way trading is typically carried out in the forex or any other financial market. They should also avoid any activities that may cause financial or other harm to Equinox Trading Capital, such as over-leveraging, over-exposure, making one-sided bets, or account rolling. If the customer engages in any of these activities, it may raise valid concerns that they are intentionally harming Equinox Trading Capital.
<br/><br/>As one of our customers, you should be aware of this and acknowledge that all of our services are intended solely for personal use by the customer. As a result, only you may access your Equinox Trading Capital Account and execute transactions. Hence, you should not, and you therefore do not,
<br/><br/><br/>
<br/><br/>Neither you nor any third party shall participate in or collaborate with any third party to have such third party execute trades for you, whether such third party is a private individual or a professional, or permit access to or trading on your Equinox Trading Capital Account by any third party;
<br/><br/>Access any third-party Equinox Trading Capital  Account, trade on behalf of any third-party, or conduct any account management or similar services where you commit to trade, run, or manage the Equinox Trading Capital  Account on behalf of another user, whether professionally or otherwise.
<br/><br/>Additionally, you agree not to abuse the Services by engaging in trades that do not adhere to market-accepted risk management guidelines for trading on financial markets. This includes, among other things, the following actions:  (i)opening positions with sizes that are noticeably larger than those of your other trades, whether on this account or another one of yours; (ii) opening positions with numbers that are noticeably smaller or larger than those of your other trades, whether on this account or another one of yours.
<br/><br/><br/>
<br/><br/>Equinox Trading Capital reserves the right to determine, at its own discretion, whether certain trades, practices, strategies or situations are Forbidden Trading Practices.
<br/><br/><br/>
<br/><br/>It is advised that all Equinox Trading Capital  clients adhere to the following trading guidelines also. Otherwise, Equinox Trading Capital won't be held responsible for whatever repercussions it chooses to have.
<br/><br/>During KYC it’s strictly recommended to provide right information and not to manipulate or try to impersonate others. It is also advised not to use any VPS/VPN during KYC verification.
<br/><br/><br/>
<br/><br/>If the Customer engages in any of the prohibited trading practices mentioned above or does not follow the guidelines, Equinox Trading Capital may pause or terminate payout. Equinox Trading Capital may also remove any trades that violate the prohibition from the Customer's trading history and not count their results in the profits and losses achieved by the demo trading. Furthermore, Equinox Trading Capital Trading reserves the right to cancel the Customer's Equinox Trading Capital  Account immediately and terminate this Agreement, and/or reduce the offered leverage on products to 1:5 or lower on any or all of the Customer's accounts. If any or all of the prohibited trading practices are performed on one or more Equinox Trading Capital Accounts of one Customer or multiple Customers, or by combining trading on Equinox Trading Capital Account and trading through Evaluation Services (i.e. Equinox Trading Capital Demo phase-1 or Phase-2), then Equinox Trading Capital Trading has the right to cancel all 
<br/><br/>Equinox Trading Capital Accounts and terminate respective agreements, used for or involved in the prohibited trading practices.
<br/><br/><br/>
Section 14 – Limitation of Liability; Disclaimer of Warranties
<br/><br/>
Equinox Trading Capital which is a concern of Equinox Trading Capital Ltd does not promise, represent, or assure that your use of our service will be error-free, speedy, secure, or uninterrupted. We do not represent that the results that may be achieved from the use of the service will be accurate or trustworthy. You accept that we may suspend the service for an extended amount of time or terminate it at any moment, with or without notice to you. You expressly acknowledge that your use of the service, or inability to utilize it, is at your own risk. The service and all products and services delivered to you via the service are provided 'as is' and 'as available for your use, without any express or implied representation, warranties, or conditions of any kind, including all implied warranties or conditions of merchantability, merchantable quality, fitness for a particular purpose, durability, title, and non-infringement.Equinox Trading Capital , our directors, officers, employees, affiliates, agents, contractors, <br/><br/>interns, suppliers, service providers, or licensors shall in no event be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation, lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability, or otherwise, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility. Because certain states or countries do not allow the exclusion or limitation of responsibility for consequential or incidental damages, our liability shall be limited to the fullest extent permissible by law in such states or jurisdictions.
<br/><br/><br/>
...
<br/><br/>
By sending an e-mail to support@equinoxtradingcapital.com, the Customer may request the termination of the Client Section at any time. Sending a request to cancel the Client Section is regarded as a request by the Customer to terminate the contract, with the Customer losing access to the Services, including the Client Section and Trading Platform. The Provider will send an email to the Customer to confirm receipt of the request, at which point the contractual relationship between the Customer and the Provider will be dissolved. The Customer is not entitled to a refund of any fees previously paid or other expenditures spent in this situation.
<br/><br/>
If the Customer engages in any of the forbidden practices repeatedly, and the Provider has previously notified the Customer thereof, the Provider may prevent the Customer from accessing all Services or their parts, including access to the
<br/><br/>
Client Section and Trading Platform, without any compensation. In such a case, the Customer is not entitled to a refund of the fees paid. After paying the fee for the selected option of the Equinox Trading Capital program, the Customer will receive the relevant login data for the Trading Platform at the e-mail address provided by the Customer or in the Client Section. The Customer activates the account by receiving the account credential. IF YOU ARE A CONSUMER, YOU ACKNOWLEDGE THAT, BY OPENING THE FIRST TRADE, YOU EXPRESSLY DEMAND THE PROVIDER TO COMPLETE THE SERVICES BEFORE THE EXPIRY OF THE PERIOD FOR WITHDRAWAL FROM THE CONTRACT, WHICH AFFECTS YOUR RIGHT TO WITHDRAW FROM THE CONTRACT. If you do not activate the Equinox Trading Capital  account within 30 calendar days of the date on which it was made available to you, your access to it will be suspended. You can request the renewal of access by sending an e-mail to support@Equinox Trading Capital .com within 3 days of the initial suspension, otherwise, we w<br/><br/>ill terminate the provision of the Services without any right to a refund of the fee.
<br/><br/>
...
<br/><br/>
If you do not begin trading within 14 days after registering, you may request a refund. It should be noted that after the trader has begun trading on the account, the fees are non-refundable. This includes both full and partial refunds.
<br/><br/><br/>
...
<br/><br/>
These Terms of Service, as well as any additional agreements under which we give you Services, are regulated and construed in accordance with the user's legal jurisdiction.
<br/><br/><br/>
Section 21 – Local Law
<br/><br/>
It's recommended to know your local regulations if there are any. You’re taking service as per your own risk and responsibilities. By declaring that you are over 18 years old and thereby Equinox Trading Capital  isn’t responsible for any action taken by its customer. If there is any violation of local law, you are solely responsible for this.
<br/><br/><br/>
Section 22– Changes to Terms of Service
<br/><br/>
The user's legal jurisdiction governs and is construed in line with these Terms of Service and any other agreements whereby we provide you Services.
<br/><br/><br/>
Section 23 - Disclaimer of Warranties and Limitation of Liability
<br/><br/>
“You acknowledge and agree that the service and company website are provided on an “as-is” basis and without warranty of any kind, including, but not limited to warranties of title, merchantability, accuracy, fitness for a particular purpose, security, and non-infringement. wherever permitted by law, you acknowledge that the company will not be held responsible or liable for any claims, damages, judgments, charges, or fees arising out of or related to information on the website and your use of or access to the service or the company website, including, but not limited to compensatory damages, consequential damages, special damages, incidental damages, punitive damages, exemplary damages, costs and attorneys’ fees, damages arising out of errors or omissions, and damages arising out of the unavailability of the website or downtime. you acknowledge that your use of the services and/or the company website is at your sole risk and that the company’s liability is limited to the amount that you paid to use the services or $1,000, whichever is less.” HFT traders will be able to request the first payout after 6 weeks (45 Days) from the first trade placed on their funded account.
Trader's will not be able to request more than 3% payout of their funded account balance. HFT trader's must be consistent, trader's without consistency will be put under review and it is under companies discretion to take action (Payout and accounts related).
<br/><br/><br/>
