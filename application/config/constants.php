...
// define('SQUARE_CUSTOM_ENVIRONMENT','SAND');


//square
define('SQUARE_ENVIRONMENT','production');
define('SQUARE_APPLICATION_ID','sq0idp-GcAPaPVR9FLTHOwONzwyOA');
define('SQUARE_ACCESS_TOKEN','EAAAEUUfzhbPq3We7zWXqzD4RgNdTeOfV-tDnSXxNKd2R0ttYwY14irgs3nnp6zH');
define('SQUARE_LOCATION_ID','LE6MZYTT5T6EE');
define('SQUARE_CUSTOM_ENVIRONMENT','PRODUCTION');